...
HD_PWD='C:/Users/cerva/Escritorio/F.Prog/Arquitectura de PC/regA/regA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log regA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source regA.tcl
