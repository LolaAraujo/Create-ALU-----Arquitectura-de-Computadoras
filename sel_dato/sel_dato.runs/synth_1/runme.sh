...
HD_PWD='C:/Users/cerva/Escritorio/F.Prog/Arquitectura de PC/sel_dato/sel_dato.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sel_dato.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sel_dato.tcl
