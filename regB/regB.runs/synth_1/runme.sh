...
HD_PWD='C:/Users/cerva/Escritorio/F.Prog/Arquitectura de PC/regB/regB.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log regB.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source regB.tcl
