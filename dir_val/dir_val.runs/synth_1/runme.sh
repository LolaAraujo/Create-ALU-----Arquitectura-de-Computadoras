...
HD_PWD='C:/Users/cerva/Escritorio/F.Prog/Arquitectura de PC/dir_val/dir_val.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dir_val.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dir_val.tcl
