...
HD_PWD='C:/Users/cerva/Escritorio/F.Prog/Arquitectura de PC/DecoBINHEX/DecoBINHEX.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DecoBINHEX.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DecoBINHEX.tcl
