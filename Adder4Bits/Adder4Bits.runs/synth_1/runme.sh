...
HD_PWD='C:/Users/cerva/Escritorio/F.Prog/Arquitectura de PC/Adder4Bits/Adder4Bits.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Adder4Bits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Adder4Bits.tcl
