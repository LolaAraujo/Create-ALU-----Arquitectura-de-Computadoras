...
HD_PWD='C:/Users/cerva/Escritorio/F.Prog/Arquitectura de PC/stack/stack.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stack.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stack.tcl
