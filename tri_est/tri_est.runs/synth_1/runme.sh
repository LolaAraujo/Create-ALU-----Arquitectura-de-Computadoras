...
HD_PWD='C:/Users/cerva/Escritorio/F.Prog/Arquitectura de PC/tri_est/tri_est.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tri_est.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tri_est.tcl
