...
HD_PWD='C:/Users/cerva/Escritorio/F.Prog/Arquitectura de PC/indice/indice.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log indice.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source indice.tcl
